package com.example.demotda.constant;
...
public class Constants {
    public class UrlPath{
        ...
        public static final String URL_ADD_PRODUCT_ADMIN="/addProduct";
        public static final String URL_VIEW_UPDATE_PRODUCT_ADMIN="/admin/updateProduct";
        public static final String URL_UPDATE_PRODUCT_ADMIN="/admin/updateProduct";
